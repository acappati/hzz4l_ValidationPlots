...
if (period == "data2016"):
        ...
        #SumWeight_DTT = counterTT.GetBinContent(1)
...
for event in tDY:
	...
	ZMass_MC.Fill(event.ZMass,event.overallEventWeight*event.xsec*1000*lumi/SumWeight_DY)
...
tdata.Draw("ZMass >> ZMass_data",                "(ZMass > 70 && ZMass < 110) && (LepPt[0] > 30 && LepPt[1] > 30)")
...
DrawRatioPlot(DIR+"ZMass", "ZMass", "Events/1 GeV", c, ZMass_data, ZMass_MC, ZMass_MC, ZMass_MC, False)
