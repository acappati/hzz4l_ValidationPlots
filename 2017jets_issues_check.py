...
# *********************************************
# usage: 
#    python 2017jets_issues_check.py
#
# *********************************************
...
DIR = "/afs/cern.ch/work/e/elfontan/private/HZZ/RUN2_Legacy/CMSSW_10_2_15/src/ZZAnalysis/AnalysisStep/test/hzz4l_ValidationPlots/" + period + "_jets_issues_check_ZTree/"
...
for event in tDY:
        ...
        if (event.JetEta.size() > 0 and event.JetRawPt.at(0) < 50. and (math.fabs(event.JetEta.at(0)) > 2.65 and math.fabs(event.JetEta.at(0)) < 3.139)): continue 
...
outFile = TFile.Open(DIR+"etaDistributions_" + period + "_ZTree.root", "RECREATE")
outFile.cd()
...
c = ROOT.TCanvas()
DrawRatioPlot(DIR+"rawPTcheck_leadingJet_Eta_NOjetID_NOpuID", "Leading jet #eta", "Events/0.2", c, leadingJet_Eta_noID_data, leadingJet_Eta_noID_MC, leadingJet_Eta_noID_MCup, leadingJet_Eta_noID_MCdn, False)
DrawRatioPlot(DIR+"rawPTcheck_leadingJet_Eta_jetID_NOpuID", "Leading jet #eta", "Events/0.2", c, leadingJet_Eta_jetID_data, leadingJet_Eta_jetID_MC, leadingJet_Eta_jetID_MCup, leadingJet_Eta_jetID_MCdn, False)
DrawRatioPlot(DIR+"rawPTcheck_leadingJet_Eta_jetID_puID", "Leading jet #eta", "Events/0.2", c, leadingJet_Eta_PUID_data, leadingJet_Eta_PUID_MC, leadingJet_Eta_PUID_MCup, leadingJet_Eta_PUID_MCdn, False)
